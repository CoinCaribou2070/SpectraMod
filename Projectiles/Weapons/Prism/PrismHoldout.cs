...
{
    public abstract class PrismHoldout : ModProjectile
    {
        /// <summary>
        /// The vanilla Last Prism is an animated item with 5 frames of animation.
        /// </summary>
        public abstract int NumAnimationFrames();

        /// <summary>
        /// This controls how many individual beams are fired by the Prism.
        /// </summary>
        public abstract int NumBeams();
        ...
        /// </summary>
        public abstract float DamageStart();
        ...
        /// </summary>
        public abstract float MaxManaConsumptionDelay();
        /// <summary>
        /// When capped out, the Prism consumes mana once every MinManaConsumptionDelay frames.
        /// </summary>
        public abstract float MinManaConsumptionDelay();

        public abstract Color DrawColor();

        public abstract int BeamType();

        public abstract float DamageMulti();
        ...
        private void UpdateAnimation()
        {
            ...
            int framesPerAnimationUpdate = FrameCounter >= ChargeTime() ? 2 : FrameCounter >= (ChargeTime() * 0.66f) ? 3 : 4;
        ...
        private void FireBeams()
        {
            ...
            int damage = (int)(projectile.damage * DamageMulti());
            float knockback = projectile.knockBack;
            for (int b = 0; b < NumBeams(); ++b)
            {
                Projectile.NewProjectile(projectile.Center, beamVelocity, BeamType(), damage, knockback, projectile.owner, b, uuid);
            }
